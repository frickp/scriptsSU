function [output, shuffled] = calculateTFVariance(filteredData,filteredPeakAssoc,bgParem,readSort)
...
clear paddedPAS filteredPeakAssocSort filteredPeakAssocSort filteredPeakAssocSort % clear from memory

% initialize for fast math
...
% [~,temp] = bootci(1000,{@calculateNormVarBoot1sample,ones(10),output},'alpha',0.5,'type','cper');
% output.deviationErrorCells = std(temp);
